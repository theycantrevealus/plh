...
class Pegawai extends Utility
{
  ...
  public function __GET__($parameter = array())
  {
    ...
    } else if ($parameter[1] == 'get_pegawai_select2') {
      return self::get_pegawai_select2();
  ...
  private function get_pegawai_select2()
  {
    $data = self::$query->select('pegawai', array(
      'uid', 'nama'
    ))

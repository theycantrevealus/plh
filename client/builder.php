...
<body class="layout-default">
  ...
  } else if (__PAGES__[0] == 'outlet') {
    require 'pages/outlet/index.php';
  } else if (__PAGES__[0] == 'pos') {
    require 'pages/pos/index.php';
  ...
  <script type="text/javascript">
    ...
    function load_tax() {
      var data = [];
      $.ajax({
        url: __HOSTAPI__ + "/Accounting/tax",
    ...
    $(function() {
      ...
      function reloadSession(idleCheck) {
        var excludedPages = ['display_dokter', 'display', 'anjungan', 'outlet', 'pos'];

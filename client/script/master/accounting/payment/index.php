    ...
    var tabletipe = $("#table-tipe").DataTable({
      ...
      "columns": [{
        ...
        },
        {
          "data": null,
          render: function(data, type, row, meta) {
            return "<span id=\"nama_" + row.uid + "\">" + row.keterangan + "</span>";
          }
        },
        {
          "data": null,
    ...
    $("body").on("click", ".btn-delete-tipe", function() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
            url: __HOSTAPI__ + "/Accounting/payment_method/" + uid,
    ...
    $("#btnSubmit").click(function() {
      ...
      if (kode !== "" && nama !== "") {
        $.ajax({
          ...
          type: "POST",
          data: {
            request: (MODE === 'tambah') ? 'tambah_payment_method' : 'edit_payment_method',
            uid: selectedUID,
            kode: kode,
            nama: nama
          },
  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modal-large-title">Tambah Payment Method</h5>
      ...
      <div class="modal-body">
        ...
        <div class="form-group col-md-12">
          <label for="txt_nama">Keterangan:</label>
